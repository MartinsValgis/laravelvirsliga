...
<body>
    ...
    <div class="bg-danger py-3">
        <div class="d-flex">
            <div class="ps-3">
                <a href="/"><img src="{{ asset('other/virsligalogo.png') }}" alt="Virslīga Logo" class="img-fluid img100"></a>
            </div>
                ...
                <div class="container">
                    <div class="d-flex justify-content-center flex-wrap gap-3 mb-3">
                        ...
                        <a href="/team/{{$team['id']}}" class="d-inline-block">
                            <img src="{{ asset($team['logo_path']) }}" alt="{{$team['name']}}" class="img-fluid img40">
                        </a>
                        @endforeach
                    </div>
                    <div class="d-flex justify-content-center gap-3">
                        <a href="/" class="btn border border-warning text-warning">Kalendārs</a>
                        <a href="/table" class="btn border border-warning text-warning">Turnīra tabula</a>
